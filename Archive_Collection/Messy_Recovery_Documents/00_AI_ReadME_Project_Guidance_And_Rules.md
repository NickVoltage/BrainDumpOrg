...
- May be maintained as separate file or embedded
...
4. **01_Project_Research_Agenda.md**
...
5. **01_Research_*.md** (Multiple Documents)
...
6. **02_Dev_Best_Practices_Research.md**
...
8. **00_Architecture_Decisions.md** (Future)
...
10. **08_Development_Practices_And_Testing.md**
...
11. **09_Development_Tips_And_Tricks.md**
...
Update 2:
- `02_Dev_Best_Practices_Research.md` - Development practices
- `04_Proposed_Selections_From_Project_Planning.md` - Technology selections and decisions
...
Update 3:
12. **10_AI_Reliable_Development_And_Debugging.md**
...
2. **01_Archived_Implementation_Plans/**
...
4. **03_Archived_Changelogs_And_Debugging_Reports/**
...
13. **00_Architecture_Decisions.md** (Future)
    - **Purpose:** Document significant architecture decisions and rationale
    - **When to Create:** When major architecture decisions are made

14. **00_Coding_Standards.md** (Future)
    - **Purpose:** Detailed coding style and standards
    - **When to Create:** When specific style guidelines are needed

15. **00_Testing_Guidelines.md** (Future)
    - **Purpose:** Testing requirements, patterns, and best practices
    - **When to Create:** When testing standards are established

16. **00_Git_Workflow.md** (Future)
    - **Purpose:** Version control workflow and conventions
    - **When to Create:** When team workflow is established

17. **00_Deployment_Process.md** (Future)
    - **Purpose:** Deployment procedures and requirements



Update 6:
13. **00_Development_Journey.md**
...
**GUI-First Development Workflow (CRITICAL):**
...
**Reference Documents:**
- `13_Dev_Niceities.md` - Content type system and GUI development patterns
...
14. **12_Pre_Implementation_Plan_Conversation.md**
...
16. **00_Architecture_Decisions.md** (Future)
    - **Purpose:** Document significant architecture decisions and rationale
    - **When to Create:** When major architecture decisions are made

17. **00_Coding_Standards.md** (Future)
    - **Purpose:** Detailed coding style and standards



Update 19 (possible repeat):
**Reference Documents:**
- `00_Dev_Niceities.md` - Content type system and GUI development patterns
- `12_Pre_Implementation_Plan_Conversation.md` - Decision tracking and workflow details

Update 20 (possible repeat):

15. **00_Dev_Niceities.md**
    - **Purpose:** Development approaches, patterns, and quality-of-life improvements



Update 21 (possible repeat):
